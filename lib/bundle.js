...
var Game = function () {
  function Game() {
    ...
    this.tank = new _tank2.default(200, 0, ctx);
    this.tank2 = new _tank2.default(800, 0, ctx);
    ...
    window.addEventListener('keyup', function (event) {
      ...
      if (keyName == ' ') _this.UI.stopAdjustPower(_this.currentTank);
    });
  }

  _createClass(Game, [{
    key: 'bindKeys',
    value: function bindKeys(event) {
      var keyName = event.key;
...
var gameLoop = function gameLoop() {
  ...
  window.stage.render(game.ctx);
  game.tank.render(game.ctx);
  game.tank2.render(game.ctx);
...
var Tank = function () {
  ...
  _createClass(Tank, [{
    ...
    value: function draw() {
      ...
      window.UI.ctx.fillRect(this.x - 15, this.y - 20, this.width + 30, 4);
      window.UI.ctx.fillStyle = 'rgba(0,255,0,1)';
      window.UI.ctx.fillRect(this.x - 15, this.y - 20, (this.width + 30) * (this.health / this.maxHealth), 4);
    ...
    value: function hitTest(x, y, width, height) {
      ...
      for (var _i = 0; _i < array.length; _i++) {
        ...
        if (this.ctx.getImageData(array[_i][0], array[_i][1], 1, 1).data[0] != 0 || this.ctx.getImageData(array[_i][0], array[_i][1], 1, 1).data[1] != 0 || this.ctx.getImageData(array[_i][0], array[_i][1], 1, 1).data[2] != 0 || this.ctx.getImageData(array[_i][0], array[_i][1], 1, 1).data[3] != 0) {
          return true;
        }
      }
      return false;
    ...
    value: function fire(power) {
      ...
      console.log(_guntanks2.default.tanks);
      if (this.face === 'right') {
        var shell = new _shell3.default(this.x + this.width, this.y, power * this.shellSpeed * Math.cos(this.angle * Math.PI / 180), -power * this.shellSpeed * Math.sin(this.angle * Math.PI / 180), this.shellRadius, this.ctx, window.tanks);
        return shell;
      } else if (this.face === 'left') {
        var _shell = new _shell3.default(this.x - 16, this.y, -power * this.shellSpeed * Math.cos(this.angle * Math.PI / 180), -power * this.shellSpeed * Math.sin(this.angle * Math.PI / 180), this.shellRadius, this.ctx, window.tanks);
        return _shell;
      }
    }
  }, {
...
var Shell = function () {
  function Shell(x, y, xVel, yVel, radius, ctx, tanks) {
  ...
  _createClass(Shell, [{
    ...
    value: function hitTest(x, y, width, height) {
      ...
      for (var _i2 = 0; _i2 < array.length; _i2++) {
        // console.log(this.ctx.getImageData(array[i][0],array[i][1],1,1).data);
        if (this.ctx.getImageData(array[_i2][0], array[_i2][1], 1, 1).data[0] != 0 || this.ctx.getImageData(array[_i2][0], array[_i2][1], 1, 1).data[1] != 0 || this.ctx.getImageData(array[_i2][0], array[_i2][1], 1, 1).data[2] != 0 || this.ctx.getImageData(array[_i2][0], array[_i2][1], 1, 1).data[3] != 0) {
          return 'terrain';
        }
      }
      return false;
