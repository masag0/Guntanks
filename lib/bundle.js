  ...
  _createClass(Game, [{
    ...
    value: function render() {
      ...
      for (var _i = 0; _i < this.objects.length; _i++) {
        ...
        if (this.objects[_i] && (Math.abs(this.objects[_i].x) > 2400 || Math.abs(this.objects[_i].y) > 2400)) {
    ...
    value: function startTurns() {
      ...
      this.interval = setInterval(function () {
        if (_this2.currentTank.turnOver) {
          ...
          _this2.time--;
          document.getElementById('main-timer').innerHTML = _this2.time;
        }
      }, 1000);
...
var Tank = function () {
  ...
  _createClass(Tank, [{
    ...
    value: function fire(power) {
      ...
      if (this.face === 'right') {
        var shell = new _shell3.default(this.x + this.width, this.y - 5, power * this.shellSpeed * Math.cos(this.angle * Math.PI / 180), -power * this.shellSpeed * Math.sin(this.angle * Math.PI / 180), this.shellRadius, this.ctx, this.ctxTerrain);
        return shell;
      } else if (this.face === 'left') {
        var _shell = new _shell3.default(this.x - 16, this.y - 10, -power * this.shellSpeed * Math.cos(this.angle * Math.PI / 180), -power * this.shellSpeed * Math.sin(this.angle * Math.PI / 180), this.shellRadius, this.ctx, this.ctxTerrain);
        return _shell;
      }
    }
  }, {
...
var Shell = function () {
  function Shell(x, y, xVel, yVel, radius, ctx, ctxTerrain) {
