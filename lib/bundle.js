...
var Tank = function () {
  ...
  _createClass(Tank, [{
    ...
    value: function draw() {
      ...
      window.UI.ctx.fillRect(this.x - 15, this.y - 40, this.width + 30, 4);
      window.UI.ctx.fillStyle = 'rgba(0,255,0,1)';
      window.UI.ctx.fillRect(this.x - 15, this.y - 40, (this.width + 30) * (this.health / this.maxHealth), 4);
      ...
      if (this.face == 'right') {
        ...
        window.UI.ctx.arc(this.x, this.y, 60, (this.angle + 30) * Math.PI / 180, (this.angle - 30) * Math.PI / 180);
  ...
  _createClass(Shell, [{
    ...
    value: function render(ctx) {
      ...
      if (this.hitTest(this.x, this.y, this.radius * 2, this.radius * 2) === 'tank') {
        ...
        if (this.hitObject.health > 0) this.hitObject.health -= this.damage;
