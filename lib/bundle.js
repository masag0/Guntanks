...
var terrainCanvas = document.getElementById('terrain-canvas');
var ctx = can.getContext('2d');
var ctxTerrain = terrainCanvas.getContext('2d');
...
var Game = function () {
  function Game() {
    ...
    this.tank = new _tank2.default(200, 0, ctx, ctxTerrain);
    this.tank2 = new _tank2.default(800, 0, ctx, ctxTerrain);
    this.stage = new _stage2.default(ctxTerrain);
...
var Tank = function () {
  function Tank(x, y, ctx, ctxTerrain) {
