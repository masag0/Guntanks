...
var gameLoop = function gameLoop() {
  ...
  for (var i = 0; i < game.objects.length; i++) {
    ...
    if (Math.abs(game.objects[i].x) > 1800 || Math.abs(game.objects[i].y) > 1800) {
...
var Tank = function () {
  ...
  _createClass(Tank, [{
    ...
    value: function fire(power) {
      console.log(power);
      if (this.face === 'right') {
        var shell = new _shell3.default(this.x + this.width, this.y, power * this.shellSpeed * Math.cos(this.angle * Math.PI / 180), -power * this.shellSpeed * Math.sin(this.angle * Math.PI / 180), this.shellRadius, this.ctx);
        return shell;
      } else if (this.face === 'left') {
        var _shell = new _shell3.default(this.x, this.y, -power * this.shellSpeed * Math.cos(this.angle * Math.PI / 180), -power * this.shellSpeed * Math.sin(this.angle * Math.PI / 180), this.shellRadius, this.ctx);
        return _shell;
      }
    }
  }, {
...
var Shell = function () {
  function Shell(x, y, xVel, yVel, radius, ctx) {
    ...
    this.radius = radius;
    this.ctx = ctx;
    this.weight = 0.5; //0.05 is about right
  }
  ...
  _createClass(UI, [{
    ...
    value: function stopAdjustPower(tank) {
      ...
      setTimeout(function () {
        ...
        _this.game.addObject(tank.fire(45, power));
      }, 250);
    }
  }]);
