...
var canUI = document.getElementById('ui-canvas');
var ctxUI = canText.getContext('2d');
...
var Game = function () {
  function Game() {
    ...
    this.tank = new _tank2.default('Player 1', 200, 0, ctx, ctxTerrain);
    this.tank2 = new _tank2.default('Player 2', 800, 0, ctx, ctxTerrain);
  ...
  _createClass(Game, [{
    ...
    value: function startTurns() {
      ...
      this.interval = setInterval(function () {
        console.log(_this2.currentTank.turnOver);
...
var Tank = function () {
  ...
  _createClass(Tank, [{
    ...
    value: function draw() {
      ...
      window.UI.ctx.fillStyle = 'white';
      window.UI.ctx.fillText(this.username, this.x - 15, this.y + this.height + 35);
    ...
    value: function fire(power) {
      ...
      if (this.face === 'right') {
        var shell = new _shell3.default(this.x + this.width, this.y, power * this.shellSpeed * Math.cos(this.angle * Math.PI / 180), -power * this.shellSpeed * Math.sin(this.angle * Math.PI / 180), this.shellRadius, this.ctx, this.ctxTerrain);
        return shell;
      } else if (this.face === 'left') {
        var _shell = new _shell3.default(this.x - 16, this.y, -power * this.shellSpeed * Math.cos(this.angle * Math.PI / 180), -power * this.shellSpeed * Math.sin(this.angle * Math.PI / 180), this.shellRadius, this.ctx, this.ctxTerrain);
        return _shell;
      }
    }
  }, {
  ...
  _createClass(Shell, [{
    ...
    value: function render(ctx) {
      ...
      if (this.hitTest(this.x, this.y, this.radius * 2, this.radius * 2) === 'tank') {
        ...
        window.ctxText.fillStyle = "white";
